...
def load_emotes_from_json():
    try:
        with open("sticker-emote.json", "r", encoding="utf-8") as f:
            data = json.load(f)
        ...
        print(f"✅ Loaded {len(emote_map)} emotes from sticker-emote.json")
        return emote_map

    except Exception as e:
        print("❌ sticker-emote.json load error:", e)
        return {}
...
🎯 Target: {target_uid}
🤖 Bot Name: —͞LAM_CODEXᅠ
✅ Status: Ready to join

📱 Player will see:
"—͞LAM_CODEXᅠ wants to join your team"
...
def get_clan_info(clan_id):
    try:
        url = f"https://guild-info-d5k9.vercel.app/get_clan_info?guild_id={clan_id}"
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY —͞Ꮪʜɪʜᴀʙㅤ求 
"""
        else:
...
def get_player_ban_status(uid):
    try:
        url = f"https://9-x-ban-check.vercel.app/bancheck?key=saeed&uid={uid}"
        res = requests.get(url, timeout=10)
...
def talk_with_ai(question):
    url = f"http://ai-api-LAM CODEX-pro.vercel.app/ask?key=LAM CODEX_GAMER&question={question}"
    try:
...
def newinfo(uid):
    ...
    url = "https://info-api-pearl.vercel.app/info"
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️Dev:[FFFFFF]</> —͞Ꮪʜɪʜᴀʙㅤ求 
"""
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]LAM CODEX
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
async def get_player_name_from_uid(uid, region="BD"):
...
def remove_from_whitelist(uid_to_remove):
    ...
    if uid_str == "8995959620":  # Your UID
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]✿[00FF00]━━━━━━━━━━━━━━[FF0000]✿
[00FFFF]      WELCOME  TO  —͞Ꮪʜɪʜᴀʙㅤ求  BOT
[FF0000]✿[00FF00]━━━━━━━━━━━━━━[FF0000]✿
[FFFFFF]        Welcome To The Squad!
[FFFF00]        Use [00FF00]/help [FFFF00]to see menu
[00FFFF]        Developer : —͞Ꮪʜɪʜᴀʙㅤ求 """
...
[7CFC00]╠════════════════════╣
[7FFF00]⚡ Owner : [FFFFFF]—͞Ꮪʜɪʜᴀʙㅤ6T9
[00FFFF]✨ To purchase a GUILD BOT,
[00bFFF]please contact us on Telegram:
[FFFFFF]@shihab23 💎
[FF00FF]╚════════════════════╝
[27F5BE]✨ Developed by —͟͞͞ </> [00E5FF]—͞—͞Ꮪʜɪʜᴀʙㅤ6T9ᅠ❄️
"""
...
"""
    ...
    "{Name} তোমার বা🙂বা জনিসিং",
    "{Name} আমি কাইললা ছেরা",
    "{Name} তোমার নুনু ছোট",
    "{Name} তুমি একটা মাদারচো🙂দ",
    "{Name} তুমি একটা বাইনচো🙂দ",
    "{Name} তুমি  একটা মাদারবোর্ড",
    "{Name} তোমার বাবা জনিসিং",
               ...
               #Luck Command                                 
                        ...
                        if inPuTMsG.strip() == "/luck":
                            ...
                            admin_message = (
                                f"[C][B][00FFFF]────────────────────\n"
                                f"║  ╭──────────────╮\n"
                                f"║  │[00FFFF] ভাগ্য পরীক্ষা কেন্দ্র         │\n"
                                f"║  ╰──────────────╯\n"
                                f"║\n"
                                f"║ [FFA500]✨ {selected_message}\n"
                                f"║ ────────────────\n"
                                f"║ ⚡ [00FA9A] —͞Ꮪʜɪʜᴀʙㅤ求 BOT ⚡\n"
                                f"────────────────────"
                            )
                            await safe_send_message(response.Data.chat_type, admin_message, uid, chat_id, key, iv)
                            ...
                            try:
                                ...
                                for attempt in range(max_retries):
                                    ...
                                    if cache_data:
                                        ...
                                        # Build response
                                        status_msg = f"[B][C][00FFFF]📊 PLAYER STATUS MADE BY —͞Ꮪʜɪʜᴀʙㅤ6T9\n"
                                        status_msg += f"────────────────\n"
...
[C][B][FFFFFF]├─ ! [team_code] [00FF00]- Join Team Using Team Code
[C][B][FFFFFF]├─/exit [00FF00]- Leave Current Group
[C][B][FFFFFF]├─ /like [uid][00FF00]- Add Like Your Profile 
...
│    EMOTE CMDS                       │
╰──────────╯
[C][B][FFFFFF]┌─ /e [uid] [emote_name] [00FF00]- Play emotes without emote id
[C][B][FFFFFF]├─ /play [uid] [1-384] [00FF00]- Play emote by number (1-384)
...
[C][B][FFFFFF]├─ @evos [uid] [00FF00]- Auto Cycle All Evolution Emotes for Player
[C][B][FFFFFF]└─ @sevos [00FF00]- Stop Evolution Emote Cycle"""
                            await safe_send_message(response.Data.chat_type, evo, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            
                                            

                            info_cmnd = """[C][B][FFD700]╭──────────╮
│    INFO CMDS                           │
╰──────────╯
[C][B][FFFFFF]┌─ /info [uid] [00FF00]- Full Player Information
[C][B][FFFFFF]├─ /bio [uid] [00FF00]- Get Player Bio
[C][B][FFFFFF]├─ /clan [Clan_id]     [00FF00]- Fetch Guild Full Info
[C][B][FFFFFF]├─ /check [uid ] [00FF00]- Check player Ban Status
[C][B][FFFFFF]├─ /status [uid] [00FF00]- Check Player Real Time Status
[C][B][FFFFFF]├─/ig [username]     [00FF00]- Fetch Instagram User Info
[C][B][FFFFFF]└─ /tt [username]     [00FF00]- Fetch TikTok User Info"""


                            await safe_send_message(response.Data.chat_type, info_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            badge_cmnd = """[C][B][FFD700]╭──────────╮
│    BADGE CMDS                      │
╰──────────╯
[C][B][FFFFFF]┌─ /v1 [uid] [00FF00]- Join Request With Craftland Badge
[C][B][FFFFFF]├─ /v2 [uid] [00FF00]- Join Request With New V-Badge
[C][B][FFFFFF]├─ /v3 [uid] [00FF00]- Join Request With Moderator Badge
[C][B][FFFFFF]├─ /v4 [uid] [00FF00]- Join Request With Small V-Badge
[C][B][FFFFFF]├─ /v5 [uid] [00FF00]- Join Request With Pro Badge
[C][B][FFFFFF]└─ /spam [uid] [00FF00]- Join Requests With All Badges"""
                            ...
                            funny_cmnd = """[C][B][FFD700]╭──────────╮
│    FUNNY CMDS                      │
╰──────────╯
[C][B][FFFFFF]┌─ /gali <name> [00FF00]- 
Send Gali For Your friend 
[C][B][FFFFFF]├─ /love [name][00FF00]- Send Love For Your Girlfriend
[C][B][FFFFFF]├─ /luck [uid][00FF00]- Try Your Luck
[C][B][FFFFFF]├─ /dm [uid] [message]  [00FF00]- Sends personal message via bot
...
[C][B][FFFFFF]└─ /ai [question] [00FF00]- Ask AI Anything"""
                            ...
                            await safe_send_message(response.Data.chat_type, funny_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            spam_cmnd = """[C][B][FFD700]╭──────────╮
│    FUNNY CMDS                      │
╰──────────╯
[C][B][FFFFFF]┌─ /spm [uid] [00FF00]- Send Invite Spam  
[C][B][FFFFFF]├─ /sspm [00FF00]- Stop Invite Spam 
[C][B][FFFFFF]├─ /spam_req [00FF00]- Send friend Request spam 
[C][B][FFFFFF]├─ /mg [txt] [00FF00]- Send Message spam
[C][B][FFFFFF]├─ /msg [txt] [Count] [00FF00]- Send Message Spam For Own
[C][B][FFFFFF]├─ /lag [Team_code] [00FF00]- Team Attack (phone lag)
[C][B][FFFFFF]└─ /stop_lag [00FF00]- Stop Team Attack"""

                            await safe_send_message(response.Data.chat_type, spam_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)


                            advance_cmnd = """"[C][B][FFD700]╭──────────╮
│    ADVANCE CMDS                      │
╰──────────╯
[C][B][FFFFFF]┌─ /b [number 1-12]  [00FF00]- Bot Equip Legendary Bundle
[C][B][FFFFFF]├─ /sticker [00FF00]- Sends sticker via bot
[C][B][FFFFFF]├─ /mimic_on [name] [00FF00]- Bot Copy Your emot 
[C][B][FFFFFF]├─ /mimic_off [uid][00FF00]- Bot Off Copying Your Emot 
[C][B][FFFFFF]├─ /title [00FF00]- Send Show All Years Title 
[C][B][FFFFFF]└─ noob [00FF00]- Just See Bot replay"""

                            await safe_send_message(response.Data.chat_type, advance_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)
                            

                            whitelist_cmnd = """[C][B][FF00FF]═ Bᴀsɪᴄ ᴀɴᴅ Aɴʏ_Rᴏʟʟs ═[00E5FF][B]
...
[FF00FF] তোমরা সবাই ফলো করে দিও..!¡
 ❀️ TɪᴋTᴏᴋ :[FFFFFF]@shihab_editz_843

[b][c][00bFFF] Dᴇᴠ Aɴᴅ Cʀᴇᴅɪᴛ: —͞Ꮪʜɪʜᴀʙㅤ求
[00CED1]━━━━━━━━━━━━[1E90FF]"""
...
[00FFFF]
[FF00FF]👤 [FFFFFF]Owner  : [FF00FF]  —͞Ꮪʜɪʜᴀʙㅤ求
[00FFFF]🌐 [FFFFFF]PAID TCP BOT NITE CHAILE INBOX NAME : @shihab23
[00FFFF] ❤️‍🩹
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=UID,password=PASS")
        return None
